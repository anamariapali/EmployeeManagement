...
public class RegularView {
	 private JFrame frame;
	    ...
	    private String col_table_3[]= {"id","Numar","Comentariu"};
	        ...
	        EventQueue.invokeLater(new Runnable() {
	            public void run() {
	                try { System.out.println("Client View run");
	                    RegularView window = new RegularView(client);
	     ...
	     */
	    public RegularView( LogInCont client) {  
	    ...
	    private void initialize() {
	        ...
	        JButton btn_rate = new JButton("StausTask");
	        btn_rate.addMouseListener(new MouseAdapter() {
	            @Override
	            public void mouseClicked(MouseEvent arg0) {
	                client.btnStatusTaskClicked();
	            }
	        });
	        btn_rate.setBounds(10, 380, 121, 23);
